...
- (void)makeToastActivity:(id)position {
    ...
    //color override
    activityIndicatorView.color = [UIColor colorWithRed:(116/255.0)
                                                  green:(204/255.0)
                                                   blue:(240/255.0)
                                                  alpha:1.0];
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    wrapperView.backgroundColor = [[UIColor colorWithRed:(116/255.0)
                                                   green:(204/255.0)
                                                    blue:(240/255.0)
                                                   alpha:1.0]
    ...
    if (title != nil) {
        ...
        titleLabel.font = [UIFont fontWithName:@"AvenirNext-Medium" size:CSToastFontSize];
    ...
    if (message != nil) {
        ...
        messageLabel.font = [UIFont fontWithName:@"AvenirNext-Medium" size:CSToastFontSize];
