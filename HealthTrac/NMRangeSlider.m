...
//        else
//        {
            UIImage* image = [UIImage imageNamed:@"ht-slider-background"];
...
//        {
//            
            UIImage* image = [UIImage imageNamed:@"ht-slider-track"];
            image = [image resizableImageWithCapInsets:UIEdgeInsetsMake(0.0, 2.0, 0.0, 2.0)];
...
//        else
//        {
            UIImage* image = [UIImage imageNamed:@"ht-slider-handle"];
